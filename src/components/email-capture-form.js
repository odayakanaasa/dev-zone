...
const MAILCHIMP_URL = `https://zoomdata.us14.list-manage.com/subscribe/post-json?u=d3a650a8b5e10b6f52b23d71b&id=a6083747a8`;
...
class EmailCaptureForm extends React.Component {
  ...
  render() {
    return (
      <div
        css={{
          borderTop: `2px solid ${colors.obsidian}`,
          marginTop: rhythm(3),
          paddingTop: `${rhythm(1)}`,
        }}
      >
              ...
              <div>
                <input
                  ...
                  css={{
                    ...
                    width: `250px`,
                    ':focus': {
                      borderColor: colors.zoomdata,
                      outline: 0,
                      boxShadow: `0 0 0 0.2rem ${hex2rgba(colors.obsidian, 0.25)}`,
                    },
                  }}
                />
                <button
                  ...
                  css={{
                    ...
                    ':hover, &:focus': {
                      ...
                      backgroundColor: colors.zoomdata,
