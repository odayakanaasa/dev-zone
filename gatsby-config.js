module.exports = {
  ...
  plugins: [
    ...
    },
    {
      ...
      options: {
        siteUrl: `https://www.zoomdata.com/developers`,
      },
    },
    ...
    `gatsby-plugin-lodash`,
    {
      ...
      options: {
        name: `Zoomdata Developer Zone`,
        short_name: `Zoomdata DevZone`,
        start_url: `/`,
    ...
    `gatsby-plugin-react-helmet`,
    {
      ...
      options: {
        trackingId: ``, // Set it to Zoomdata Developer Zone
      },
    },
        ...
        feeds: [
          {
            ...
            setup: ({ query: { site: { siteMetadata } } }) => {
              return {
                ...
                generator: `Zoomdata Developer Zone`,
              };
            },
